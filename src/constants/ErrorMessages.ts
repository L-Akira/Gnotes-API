export default {
    ...
    DB_ERROR: 'Server cannot access database',
    EXISTENT_USERNAME: 'Username already exist',
    WRONG_PASSWORD: 'Wrong password',
    BAD_REQUEST: 'Something is missing or is invalid, please double check the data before sending to the API',
    DELETE_USER: 'Something hapened during user deletion, try again latter'
}